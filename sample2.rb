...
uri = URI(URI.escape("https://www.googleapis.com/customsearch/v1?key=#{custom_search_api_key}&cx=#{search_engine_id}&q=#{search_query}&hl=ja&searchType=image&start=1"))
